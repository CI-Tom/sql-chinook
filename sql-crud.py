...
billy_poison_jabs = Programmer(
    first_name="Billy",
    last_name="Poison-Jabs",
    gender="Trans",
    nationality="American",
    famous_for="Scumbag"
)
...
# session.add(billy_poison_jabs)
# session.add(tim_berners_lee)
# session.add(tom_manahan)
